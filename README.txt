...
- Tool names are the affiliate-ready links. They currently point to official tool websites.
- Update /data/affiliate-links.json: set affiliate_url for each tool after approval. The JavaScript prefers affiliate_url over website_url.
- Google Analytics measurement ID included: G-164NDV6713.

Important files:
- /data/affiliate-links.json = central link properties file
